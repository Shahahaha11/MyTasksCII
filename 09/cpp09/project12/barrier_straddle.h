#ifndef BARRIER_STRADDLE_H
#define BARRIER_STRADDLE_H

#include "path_dependent.h"
#include "payoff_bridge.h"

// this class inherits after PathDependent class
class BarrierStraddle : public PathDependent
{
public:
// constructor takes three arguments
BarrierStraddle(const MJArray &look_at_times_,
