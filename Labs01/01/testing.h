...
#include<cmath>
#include<iostream>
inline bool approx_equal(double x, double y, double eps = 1e-6) {
    return std::fabs(x - y) < eps;
}

inline void assert_equal(double expected, double actual, const char* name) {
...
inline void assert_equal_int(int expected, int actual, const char* name) {
    if (expected == actual) {
        std::cout << "[PASS] " << name << '\n';
    } else {
        std::cout << "[FAIL] " << name
